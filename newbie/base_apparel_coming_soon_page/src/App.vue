...
<template>
  ...
  >
  <!-- Left part -->
   <div class="min-h-[100dvh] bg-linear-to-br from-gradient-tl to-gradient-br sm:w-[60%] sm:flex sm:flex-col sm:items-center sm:min-h-[100dvh] sm:bg-[url(/assets/images/bg-pattern-desktop.svg)] bg-cover">
